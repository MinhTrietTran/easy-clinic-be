...
def get_patient_email(patient_id):
    """
    Service function để lấy email của patient theo patient_id
    """
    try:
        ...
        return {
            ...
            "phone": patient.user.phone if patient.user.phone else None
        }
    except Patient.DoesNotExist:
        return None
    except Exception as e:
        raise Exception(f"Error getting patient email: {str(e)}")
